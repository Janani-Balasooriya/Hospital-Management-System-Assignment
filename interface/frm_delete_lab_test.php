...
<h5 align="center" id="head">Searching Test for Deleting</h5>
...
<h4 align="center" class="my">Lab Testing Details</h4>
<form action="../db/delete_lab_test.php" method="post">

<div class="form-group row">
		<label for="rid" class="col-sm-3 col-form-label" class="sr-only">Test ID</label>
		<div class="col-sm-9">
		<input type="text" class="form-control" name="testid" required maxlength="3	" pattern="[0-9]{3}" id="rid" autofocus value="<?php echo $row['test_id'];?>" readonly>
		</div>
</div>
...
<div class="form-group row">
		...
		<div class="col-sm-9">
		<textarea class="form-control" name="testname" required  pattern="[a-zA-Z\s0-9]{100}" id="rid" readonly> <?php echo $row['test_name'];?></textarea>
		</div>
</div>
...
<div class="form-group row">
		...
		<div class="col-sm-9">
		<input type="text" class="form-control" name="testcharge" required maxlength="7" pattern="[0-9]{+}" id="rid" value="<?php echo $row['test_charge'];?>" readonly>
		</div>
</div>

<div class="form-group row">
  <div class="col-sm-10">
    <button type="submit" class="btn btn-primary mb-2">Delete Lab Test</button>
  </div>
 </div>
</form>
</div>
