...
<html>
<head>
<title>Registering Out patient</title>
...
<div class="container main_div" id="myform">
  <h5 align="center" style="font-variant:small-caps" id="head">Registering Out Patient </h5>
  <form action="../db/insert_out_patient.php" method="post">
    ...
    <div class="form-group row">
      <div class="col-sm-10">
        <button type="submit" class="btn btn-primary mb-2">Register Out Patient</button>
      </div>
    </div>
  </form>
</div>
