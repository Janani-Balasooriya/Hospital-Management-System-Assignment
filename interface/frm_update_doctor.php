...
<h5 align="center" id="head">Searching Doctor for Editing</h5>
...
<h5 align="center" id="head">Editing Doctor</h5>
<form action="../db/update_doctor.php" method="post">
...
<div class="form-group row">
		...
		<div class="col-sm-8">
		<input class="form-control" type="date" id="dob" name="dob" required value="<?//php echo $row['dob'];?>" >
		</div>
</div>
-->
...
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" name="gender" id="female" value="0" <?php if($row['gender']==0) echo 'checked' ?>>
...
<div class="col-sm-8">
	<textarea class="form-control" name="spec_area" rows="4"  cols="75" required ><?php echo $row['spec_area'];?></textarea>
</div>
</div>
...
<div class="col-sm-8">
  <input  type="text" name="hrate" id="hr" required class="form-control" value="<?php echo $row['hourly_rate'];?>" >
</div>
</div>
<div class="form-group row">
	<div class="col-sm-10">
      <button type="submit" class="btn btn-primary mb-2">Update Doctor</button>
    </div>
